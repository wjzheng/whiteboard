function Collage(canvasId) {
  ...
  function drawMarker(layer) {
    ...
    context.drawImage(rotateImg, (layer.width / 2) - rotateImg.width, 0 - (layer.height / 2));
  ...
  function isScalingArea(mX, mY, layer) {
    ...
    var square = new Square(new Vector(scaleOffsetX - scaleImg.width, scaleOffsetY - scaleImg.height), new Vector(scaleOffsetX, scaleOffsetY - scaleImg.height),
        new Vector(scaleOffsetX, scaleOffsetY), new Vector(scaleOffsetX - scaleImg.width, scaleOffsetY));
  ...
  function isRotatingArea(mX, mY, layer) {
    ...
    var square = new Square(new Vector(scaleOffsetX - rotateImg.width, layer.offsetY), new Vector(scaleOffsetX, layer.offsetY), new Vector(scaleOffsetX, layer.offsetY + rotateImg.height), new Vector(
        scaleOffsetX - rotateImg.width, layer.offsetY + rotateImg.height));
...
function Layer(img) {
  ...
  this.intersect = function(x, y) {
    ...
    var square = new Square(new Vector(this.offsetX, this.offsetY), new Vector(this.offsetX + this.width, this.offsetY), new Vector(this.offsetX + this.width, this.offsetY + this.height), new Vector(
        this.offsetX, this.offsetY + this.height));
